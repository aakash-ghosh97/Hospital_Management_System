<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_registration.aspx.cs" Inherits="Hospital_Management_System_1.admin_registration" %>
...
/* Add padding to containers */
        ...
        #fname, #lname, #age, #c_number, #password, #gender, #v_id, #rtw_password, #DropDownList1, #DropDownList2, #security1{
            width: 100%;
            padding: 15px;
            margin: 5px 0 22px 0;
            ...
            #fname:focus, #lname:focus, #age:focus, #c_number:focus, #password:focus, #v_id:focus, #gender:focus, #rtw_password:focus, #DropDownList1:focus, #DropDownList2:focus, #security1:focus {
...
<form runat="server">
  <div class="auto-style1">
      <a href="admin_login.aspx"><--- Go Back </a></span>
    <center>
        <h1 style="font-family: 'Times New Roman', Times, serif; font-size: 65px; font-style: normal; font-weight: 900; font-variant: normal; text-transform: none; color: #993399; text-decoration: blink;" class="auto-style2">Admin Registration</h1>
    <p style="color: #CC0000">-----Please fill in this form to register yourself.------</p>
    </center>

    <label for="v_id"><b>Vendor Id</b></label>
      <asp:Label ID="v_id" runat="server" Text="Label"></asp:Label>
...
<%--    <input type="text" placeholder="Enter your Gender" id="gender" required>--%>
    ...
    <%--<input type="number" placeholder="Enter your Contact Number" id="c_number" required>--%>
      ...
      &nbsp;<asp:TextBox TextMode="Password" ID="password" placeholder="Enter a Password" runat="server" required></asp:TextBox>
