...
{
    public partial class patient_new_password : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("update Patient set Password=@NewPassword where Password='" + TextBox3.Text + "'", con);
