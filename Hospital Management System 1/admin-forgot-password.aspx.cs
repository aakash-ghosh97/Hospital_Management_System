...
namespace Hospital_Management_System_1
{
    public partial class admin_forgot_password : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            str = "select * from Admin where VendorId='" + TextBox1.Text + "'";
            ...
            {
                Label1.Text = "Incorrect Vendor Id";
            }
        }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from Admin where Answer='" + TextBox2.Text + "'", con);
            sda.SelectCommand = cmd;
            sda.Fill(ds, "Admin");
            if (ds.Tables[0].Rows.Count > 0)
            {
                Response.Redirect("admin-new-password.aspx");
            }
            else
            {
