<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patient-test-result.aspx.cs" Inherits="Hospital_Management_System_1.patient_test_result" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <center><h2 class="auto-style2">Test Result</h2></center>
        ...
        <center>
            ...
            <br /><br /><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="PatientId" HeaderText="Patient's Name" />
                    <asp:BoundField DataField="DoctorId" HeaderText="Doctor's Id" />
                    <asp:BoundField DataField="Date" HeaderText="Date" />
                    <asp:BoundField DataField="MedicalService" HeaderText="Medical Service" />
