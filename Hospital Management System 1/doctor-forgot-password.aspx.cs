...
namespace Hospital_Management_System_1
{
    public partial class forgot_password : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from Doctor where Answer='" + TextBox2.Text + "'",con);
            sda.SelectCommand = cmd;
            sda.Fill(ds, "Doctor");
            if (ds.Tables[0].Rows.Count > 0)
            {
                Response.Redirect("doctor-new-password.aspx");
            }
            else
            {
        ...
        {
            con.Open();
            str = "select * from Doctor where DoctorId='" + TextBox1.Text + "'";
            ...
            {
                Label1.Text = "Incorrect Doctor Id";
            }
