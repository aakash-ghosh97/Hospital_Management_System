<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-forgot-password.aspx.cs" Inherits="Hospital_Management_System_1.admin_forgot_password" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br /><br /><br /><label for="app_id"><b style="font-family: Georgia, 'Times New Roman', Times, serif; font-size: large; font-style: oblique">Enter Your Vendor Id:-</b></label>
