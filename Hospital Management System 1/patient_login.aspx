<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patient_login.aspx.cs" Inherits="Hospital_Management_System_1.patient_login" %>
...
<body>
  ...
  <div class="container">
    ...
    <asp:TextBox ID="uname" placeholder="Enter your Patient Id" runat="server" required></asp:TextBox>
    ...
    <button type="button" onclick="window.location.href  = 'patient-registration.aspx';" class="rgstrbtn">Register</button>
  </div>

  <div class="container" style="background-color:#f1f1f1">
    <button type="button" onclick="window.location.href  = 'home-page.aspx';" class="cancelbtn">Cancel</button>
    <span class="psw">Forgot <a href="patient-forgot-password.aspx">password?</a></span>
  </div>
