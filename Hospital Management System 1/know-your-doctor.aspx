<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="know-your-doctor.aspx.cs" Inherits="Hospital_Management_System_1.know_your_doctor" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <center><h2 class="auto-style2">Know Your Doctor</h2></center>
        ...
        <center>
            ...
            <br /><br /><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="DName" HeaderText="Doctor's Name" />
