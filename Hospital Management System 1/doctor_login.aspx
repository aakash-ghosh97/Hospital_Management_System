<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doctor_login.aspx.cs" Inherits="Hospital_Management_System_1.doctor_login" %>
...
<body>
  ...
  <div class="container">
    ...
    <asp:TextBox ID="uname" placeholder="Enter your Doctor Id" runat="server" required></asp:TextBox>
  ...
  <div class="container" style="background-color:#f1f1f1">
    ...
    <span class="psw">Forgot <a href="doctor-forgot-password.aspx">password?</a></span>
  </div>
