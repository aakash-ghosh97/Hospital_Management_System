<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patient-medicare.aspx.cs" Inherits="Hospital_Management_System_1.patient_medicare" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <center><h2 class="auto-style2">Medicare Services</h2></center>

        <center>
                <div>
            <br /><br /><asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false">
                <Columns>
                    <asp:BoundField DataField="MId" HeaderText="Medicare Id" />

                    <asp:BoundField DataField="Medicare_Services" HeaderText="Medicare Services" />
                </Columns>
            </asp:GridView>
        </div>
        </center>
